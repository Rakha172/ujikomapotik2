...
invalid @enderror" id="exampleInputlevel" name="level">
                            <option value="apoteker" @if($user->level == 
'apoteker' || old('level') == 'apoteker')selected @endif>apoteker</option>
                            <option value="gudang" @if($user->level == 
'gudang' || old('level') == 'gudang')selected @endif>gudang</option>
                            <option value="kasir" @if($user->level == 
'kasir' || old('level') == 'kasir')selected @endif>kasir</option>
