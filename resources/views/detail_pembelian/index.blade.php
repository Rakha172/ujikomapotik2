...
@section('content_header') 
    <h1 class="m-0 text-dark">List Detail_Pembelian</h1>
@stop
@section('content') 
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('detail_pembelian.create')}}" class="btn 
btn-primary mb-2">
                        Tambah
                    </a>
...
table-stripped" id="example2">
                        ...
                        @foreach($detail_pembelian as $key => $detail_pembelian)
                            <tr>
                                ...
                                <td>Rp.{{number_format($detail_pembelian->sub_total_beli)}}</td>
...
$detail_pembelian)}}" onclick="notificationBeforeDelete(event, this)" class="btn btn-
danger btn-xs">
                                        Delete
                                    </a>
                                </td>
