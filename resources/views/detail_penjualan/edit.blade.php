...
@section('title', 'Edit Detail_Penjualan') 
@section('content_header') 
    <h1 class="m-0 text-dark">Edit Detail_Penjualan</h1>
@stop
@section('content') 
                ...
                <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nonota_jual') is-invalid @enderror"
                                ...
                                value="{{$detail_penjualan->fpenjualan->id ??old('nonota_jual') }}" aria-label="Nomor Nota Jual" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_obat') is-invalid @enderror"
                                placeholder="Nama Obat" id="nama_obat" name="nama_obat" value="{{$detail_penjualan->fobat->id ??old('nama_obat') }}"
                    ...
                    value="{{$detail_penjualan->jumlah_jual ??old('jumlah_jual')}}"> @error('jumlah_jual') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    ...
                    value="{{$detail_penjualan->harga_jual ??old('harga_jual')}}"> @error('harga_jual') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    ...
                    value="{{$detail_penjualan->sub_total_jual ??old('sub_total_jual')}}"> @error('sub_total_jual') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
