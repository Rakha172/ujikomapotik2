...
@section('title', 'List Detail_Penjualan') 
@section('content_header') 
    <h1 class="m-0 text-dark">List Detail_Penjualan</h1>
@stop
@section('content') 
    <div class="row">
        <div class="col-12">
...
$detail_penjualan)}}" class="btn btn-primary btn-xs">
                                    ...
                                    <a href="{{route('detail_penjualan.destroy', 
$detail_penjualan)}}" onclick="notificationBeforeDelete(event, this)" class="btn btn-
danger btn-xs">
                                        Delete
                                    </a>
                                </td>
