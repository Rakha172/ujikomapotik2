        ...
        <div class="col-12">
            <div class="card">
                ...
                <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari"
                    ...
                    value="{{old('nonota_jual')}}"> @error('Nomor Nota Jual') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                    ...
                    value="{{old('tgl_jual')}}"> @error('Tanggal Jual') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                    ...
                    value="{{old('total_jual')}}"> @error('Total Jual') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                </div>
            </div>
            </div>
                ...
                <a href="{{route('detail_penjualan.create')}}"> <button type="submit" class="btn btn-
primary">Lanjut</button>
